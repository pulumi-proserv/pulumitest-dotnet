# Contributing to pulumitest-dotnet
...
We discuss features and file bugs on GitHub via [Issues](https://github.com/pulumi-labs/pulumitest-dotnet/issues) as well as [Discussions](https://github.com/pulumi-labs/pulumitest-dotnet/discussions).
...
For larger features, we'd appreciate it if you open a [new issue](https://github.com/pulumi-labs/pulumitest-dotnet/issues/new) before investing a lot of time so we can discuss the feature together.
Please also be sure to browse [current issues](https://github.com/pulumi-labs/pulumitest-dotnet/issues) to make sure your issue is unique, to lighten the triage burden on our maintainers.
